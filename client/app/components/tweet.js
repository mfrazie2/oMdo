...
function Tweet (props) {
  ...
  <div className={props.css.chartContainer}>
    <div className={props.css.chart}>
      ...
      <BarChart data={format(props.emotional)} options={props.chartOptions} width='200%' height='200%' />
    </div>
    
    <div className={props.css.chart}>
      <h3>Writing Tone</h3>
      <BarChart data={format(props.writing)} options={props.chartOptions} width='200%' height='200%' />
    </div>
    
    <div className={props.css.chart}>
      <h3>Social Tone</h3>
      <BarChart data={format(props.social)} options={props.chartOptions} width='200%' height='200%' />
    </div>
  </div>
  )
}
