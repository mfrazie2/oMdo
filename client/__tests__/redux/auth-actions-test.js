...
describe('sign up', function(){
  it('should have a function signUpSubmit that returns an action type SIGN_UP_SUBMIT', function(){
  ...
  it('should have a function signUpSucess that returns an action type SIGN_UP_SUCCESS', function(){
  ...
  it('should have a function signUpFailure that returns an action type SIGN_UP_FAILURE', function(){
...
describe('sign in', function(){
  it('should have a function signInSubmit that returns an action type SIGN_IN_SUBMIT', function(){
  ...
  it('should have a function signUpSucess that returns an action type SIGN_IN_SUCCESS', function(){
  ...
  it('should have a function signUpFailure that returns an action type SIGN_IN_FAILURE', function(){
